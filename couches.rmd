...
returnDf <- function (model, input_coef) 
{
  ...
  # lasso_coef_df <- lasso_coef_df %>% rename(paste("coefs", city, sep = "_") = )
...
# lasso_coef_df_normalised <- lasso_coef_df %>%
lasso_coef_df
```
...
```
```{r}
lasso_coef_df.sin <- as.data.frame(summary(coef(lasso_cv_sin)))
lasso_coef_df.sin
```
# Training the Model
